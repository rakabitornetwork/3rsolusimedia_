            ...
            <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end sm:justify-between">
                <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-end">
                    ...
                    <p className="max-w-md pb-2 text-sm text-ink-soft">
                        Profile ini disimpan di MikroTik (`/ppp/profile`), lalu bisa dipetakan lewat Profile
                        Layanan.
                    </p>
                </div>
                <div className="admin-toolbar-actions">
                    <Link
                        href={`/admin/customers/pppoe/mikrotik-profiles/create${
                            ...
                            <tr key={item.id || item.name} className="border-b border-ink/5 last:border-0">
                                ...
                                <td className="px-4 py-3">
                                    <div className="admin-actions">
                                        <Link
                                            href={`/admin/customers/pppoe/mikrotik-profiles/${selected_router_id}/edit/${encodeURIComponent(item.id)}`}
                        ...
                        {profiles.length === 0 && (
                            <tr>
                                <td colSpan={7} className="px-4 py-10 text-center text-ink-soft">
                                    {selected_router_id
                                        ? 'Belum ada PPP profile di router ini.'
